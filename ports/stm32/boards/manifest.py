...
freeze("$(MPY_DIR)/ports/stm32/modules", ("BasicGraphics.py", "BrainPad.py", "BrainPadDisplay.py", "BrainPadType.py", "BrainPadUtil.py", "MC3216Controller.py", "TickLedMatrix.py"))